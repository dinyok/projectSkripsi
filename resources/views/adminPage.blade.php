                      ...
                      <table class="table" data-aos="fade-up">
                        ...
                        @foreach ($users as $user)
                          <tr>
                            ...
                            <td>{{ $user->name }} @if ($user->deleted_at != null)
                            <strong>(Deleted)</strong>
                            @endif</td>
                            <td>
                            @role('admin')
                              <!-- <button type="button" class="btn btn-success" data-toggle="modal" data-target="#restoreModal">Restore</button> -->
                              <a href="/adminPage/restore/{{ $user->user_id }}" class="btn btn-success" onclick="return confirm('Apakah anda ingin mengembalikan user?')">Restore</a>
                              <a href="/adminPage/show/{{ $user->user_id }}" class="btn btn-primary">Show File</a>
                              <a href="/adminPage/delete/{{ $user->user_id }}" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus user?')">Delete</a>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="/adminPage/delete/{{ $user->user_id }}" class="btn btn-primary">Delete</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="modal fade" id="restoreModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Apakah anda ingin mengembalikan User?
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <a href="/adminPage/restore/{{ $user->user_id }}" class="btn btn-primary">Restore</a>
                          </div>
                        </div>
                      </div>
                    </div> -->
